...
def gerar_relatorio_final(texto_ref, texto_belfar, nome_ref, nome_belfar, tipo_bula):
    ...
    # --- INÍCIO DA CORREÇÃO DE LAYOUT (v27.0) ---
    def formatar_html_para_leitura(html_content, is_ref_pdf=False):
        ...
        # 1. Preserva parágrafos reais (2+ quebras) com um marcador
        # Também captura títulos ALL CAPS como parágrafos
        ...
        # 2. Adiciona quebras ANTES de títulos numerados (ex: "1. PARA...", "9. O QUE...")
        html_content = re.sub(
            r'(\n)(\d+\.\s+)', # \n seguido de "d. "
            r'[[PARAGRAPH]]\2',     
            html_content
        ...
        if is_ref_pdf:
            ...
            # remover as quebras de linha únicas restantes.
            html_content = html_content.replace('\n', ' ')
        else:
            # Texto do Marketing: Precisa ser "embelezado"
            # Substitui as quebras de layout restantes por espaço
            html_content = html_content.replace('\n', ' ')

        # 4. Restaura os marcadores
    ...
    if diferencas_conteudo:
        ...
        for diff in diferencas_conteudo:
            with st.expander(f"📄 {diff['secao']} - ❌ CONTEÚDO DIVERGENTE"):
                ...
                # Aplica a formatação condicional v27.0
...
if st.button("🔍 Iniciar Auditoria Completa", use_container_width=True, type="primary"):
    if pdf_ref and pdf_belfar:
        with st.spinner("🔄 Processando e analisando as bulas..."):
            ...
            # --- INÍCIO DA CHAMADA CORRIGIDA v27.0 ---
...
st.divider()
st.caption("Sistema de Auditoria de Bulas v27.0 | Correção Híbrida (Lógica 'sort=False', Visual 'Smart-Flow')")
